...
unsigned char checkHit(unsigned char, unsigned char);
unsigned char missileCloseToEnemy(void);
...
unsigned char checkHit(unsigned char i, unsigned char j){
...
void Bunker_Init(void){unsigned char i;
	for (i = 0; i < 3; i++){
		Bunker[i].x = 7 + i * 26;
